...
Create new migration (new file in `vc_buildserver/migrations/versions/`):
...
If u wanna create new file with tables u should import tables to `vc_buildserver/migrations/env.py`

```
import vc_buildserver.users.tables # import new files here
```
